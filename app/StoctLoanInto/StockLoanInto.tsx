    ...
    <div className="px-4 md:px-10  py-10 lg:px-14 xl:px-30 2xl:px-52">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 gap-4">
        <div className=" shadow rounded-lg text-center">
          ...
          <p className="text-sm text-gray-600 mb-3">계좌당 최고 21억 대출</p>
        </div>
        <div className=" shadow rounded-lg text-center">
          <img
            src={Security}
            ...
            className="w-full h-52 object-cover mb-3"
          />
          <p className="font-bold mb-3">비대면 계좌 개설 및 당일 대출과 업계 최저금리</p>
        </div>
        <div className="shadow rounded-lg text-center">
          <img
            src={Account}
            ...
            className="w-full h-52 object-cover mb-3"
          />
          <p className="font-bold mb-3">한 종목 100% 집중 투자 및 1:1 상담원 배정</p>
        </div>
        <div className=" shadow rounded-lg text-center">
          <img
            src={Focused}
           ...
           className="w-full h-52 object-cover mb-3"
          />
          <p className="font-bold mb-3">증권사 관계없이 전 증권사 대환대출 가능</p>
        </div>
      </div>
    </div>
  );
